 ...
 * @desc    description
 */
class ChinaumsAllocationWeixinH5
{
    // 插件配置参数
    private $config;
    ...
    public function Config()
    {
        ...
        $base = [
            ...
            'desc'          => '适用微信h5，分账模式支付方式。 <a href="https://www.chinaums.com/" target="_blank">立即申请</a>',  // 插件描述（支持html）
            'author'        => 'Devil',  // 开发者
    ...
    public function Pay($params = [])
    {
        ...
        return PaymentHandleService::Pay('weixin-h5', $params);
    }
