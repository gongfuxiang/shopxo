...
class AllinpayUnionpay
{
    ...
    public function Config()
    {
        // 基础信息
        $base = [
            'name'          => '通联支付分账-云闪付扫码支付',  // 插件名称
            'version'       => '1.0.0',  // 插件版本
            'apply_version' => '不限',  // 适用系统版本描述
            'apply_terminal'=> ['pc', 'h5'], // 适用终端 默认全部 ['pc', 'h5', 'app', 'alipay', 'weixin', 'baidu']
            'desc'          => '适用PC+H5【云闪付APP】扫码支付，分账模式支付方式。 <a href="https://www.allinpay.com/" target="_blank">立即申请</a>',  // 插件描述（支持html）
            'author'        => 'Devil',  // 开发者
    ...
    public function Pay($params = [])
    {
        ...
        return PaymentHandleService::Pay('unionpay', $params);
    }
