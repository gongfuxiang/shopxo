 ...
 * @desc    description
 */
class ChinaumsAllocationPublic
{
    // 插件配置参数
    private $config;
    ...
    public function Config()
    {
        ...
        $base = [
            ...
            'desc'          => '适用公众号，分账模式支付方式。 <a href="https://www.chinaums.com/" target="_blank">立即申请</a>',  // 插件描述（支持html）
            'author'        => 'Devil',  // 开发者
    ...
    public function Pay($params = [])
    {
        ...
        return PaymentHandleService::Pay('public', $params);
    }
