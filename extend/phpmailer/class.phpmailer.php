...
class PHPMailer {
   ...
   * If HTML then run IsHTMlang(true).
   * @var string
   */
  public $Body              = '';
 ...
 /**
   ...
   * @return void
   */
  public function IsHTMlang($ishtml = true) {
    if ($ishtml) {
 ...
 */
  ...
  */
  ...
  public function WrapText($message, $length, $qp_mode = false) {
    ...
    $message = $this->FixEOlang($message);
  ...
  */
   ...
   * @return string
   */
  private function FixEOlang($str) {
    $str = str_replace("\r\n", "\n", $str);
    $str = str_replace("\r", "\n", $str);
    $str = str_replace("\n", $this->LE, $str);
    return $str;
   ...
   * @return $message
   */
  public function MsgHTMlang($message, $basedir = '') {
