...
return [
    ...
    'common'            => [
        ...
        'upload_in_text'                        => '上傳中…',
        'navigation_main_quick_name'            => '百寶箱',
        ...
        // 公共顶部小导航-左侧导航
        'header_top_nav_left_not_login_first'   => '您好，歡迎來到',
    ...
    'buy'               => [
        ...
        'no_delivery_address_tips'              => '沒有收貨地址',
    ...
    'order'             => [
        ...
        'order_base_delivery_time_title'        => '發貨時間：',
        'order_base_collect_time_title'         => '收貨時間：',
        'order_base_user_comments_time_title'   => '評論時間：',
        'order_base_cancel_time_title'          => '取消時間：',
        'order_base_express_title'              => '快遞公司：',
        'order_base_express_website_title'      => '快遞官網：',
        'order_base_express_number_title'       => '快遞單號：',
    ...
    'user'              => [
        ...
        'login_retrieve_password_title'         => '找回密碼',
        // 注册
        'register_top_login_tips'               => '我已經注册，現在就',
