...
return [
    ...
    'order'             => [
        ...
        'order_base_delivery_time_title'        => '发货时间：',
        'order_base_collect_time_title'         => '收货时间：',
        'order_base_user_comments_time_title'   => '评论时间：',
        'order_base_cancel_time_title'          => '取消时间：',
        'order_base_express_title'              => '快递公司：',
        'order_base_express_website_title'      => '快递官网：',
        'order_base_express_number_title'       => '快递单号：',
    ...
    'orderaftersale'    => [
        ...
        'form_item_images_tips'                 => '最多上传3张图片',
    ...
    'user'              => [
        ...
        'login_retrieve_password_title'         => '找回密码',
        // 注册
        'register_top_login_tips'               => '我已经注册，现在就',
