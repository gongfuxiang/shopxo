...
class I18n extends Common
{
	...
	public function Index()
	{
		...
		// 严格按 table + business_id（+可选 plugins）读取，禁止合并规格模板/其它商品数据（模板仅前台展示回退）
		$data = I18nService::ValueData($table_name, $business_id, $plugins);
		return ApiService::ApiDataReturn(DataReturn(MyLang('operate_success'), 0, $data));
	}
}
?>
