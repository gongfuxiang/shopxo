...
Page({
  ...
  onShow() {
    tt.setNavigationBarTitle({
      title: app.data.common_pages_title.user_order_comments
    });
  },
  ...
  formSubmit(e) {
    // 商品数量
    var length = this.data.detail.items.length; // 评分校验
    ...
    form_data['images'] = this.data.form_images_list.length > 0 ? JSON.stringify(this.data.form_images_list) : ''; // 提交表单
